...
$toemails[] = array(
				'email' => 'info@wockhouse.com', // Your Email Address
				'name' => 'WockHouse' // Your Name
			);
...
$fromemail = array(
				'email' => 'info@wockhouse.com', // Company's Email Address (preferably currently used Domain Name)
				'name' => 'WockHouse' // Company Name
			);
